...
student = (name = "Areeba Khan", kerberos_id = "")
...
# ╔═╡ d49960bf-bd73-402e-aa37-5e693ab8bca6
collect(Int, 0:1:100)
...
# ╔═╡ 515218b9-b26c-4cfc-9f60-f7e5591a21ec
function get_green(pixel)
	return pixel.g
end

# ╔═╡ e6cc831a-2a10-4a86-9d5f-1d9d546cc1d4
function get_greens(image::AbstractMatrix)
	# your code here!
	return get_green.(image)
end

# ╔═╡ 9b41ebd8-716c-42bd-ba01-df3e5c8d5cc2
get_greens(philip_head)

# ╔═╡ ce093cce-2608-4fe6-bd17-fe1bb4df61c5
function get_blue(pixel::AbstractRGB)
	# your code here!
	return pixel.b
end

# ╔═╡ ebd28733-9001-4029-b92c-b850f6c8b897
function get_blues(image)
	return get_blue.(image)
end

# ╔═╡ cbd6ec90-39db-4e99-b1d5-eb64b042aea8
get_blues(philip_head)
...
function custom_filter(pixel::AbstractRGB)
	...
	# g = pixel.b
	# b = pixel.r
	return RGB(pixel.g, pixel.b, pixel.r)
end
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "8c158ada1bf729cd57f46aaa88ad0ec7c67f16ce"
